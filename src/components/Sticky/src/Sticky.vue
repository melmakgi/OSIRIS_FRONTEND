...
const props = defineProps({
  // Расстояние сверху или снизу (Единица измерения px)
  offset: propTypes.number.def(0),
  // Настройка порядка укладки элементов
  zIndex: propTypes.number.def(999),
  // Установить указанный class
  className: propTypes.string.def(''),
  // Метод позиционирования，по умолчанию (top)，указывает расстояние от верхней позиции
  // может быть установлена на верхнюю или bottom
  position: {
    type: String,
