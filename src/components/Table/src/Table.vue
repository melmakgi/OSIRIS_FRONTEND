...
export default defineComponent({
  ...
  props: {
    ...
    // Следует ли выбирать более одного
    selection: propTypes.bool.def(true),
    // Все ли переполнения скрыты, с более низким приоритетом, чем showOverflowTooltip в схеме.
    ...
    // Действует только для столбцов с type=selection,
    // тип Boolean, true сохранит ранее выбранные данные после обновления данных (должен быть указан row-key).）
    reserveSelection: propTypes.bool.def(false),
    // Состояние загрузки
    loading: propTypes.bool.def(false),
    // Следует ли наложить индекс
  ...
  setup(props, { attrs, slots, emit, expose }) {
    ...
    // Реквизиты, передаваемые useTable
