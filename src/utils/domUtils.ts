...
/**
 * Получаем левое и верхнее смещения текущего элемента
 *   left：Расстояние от крайнего левого края элемента до левой части документа
 *   top: Расстояние от верхней части элемента до верхней части документа
 *   right: Расстояние от крайней правой части элемента до правой части документа
 *   bottom：Расстояние от нижней части элемента до нижней части документа
 *   rightIncludeBody：Расстояние от крайнего левого края элемента до правой части документа
 *   bottomIncludeBody：Расстояние от нижней части элемента до нижней части документа
 *
 * @description:
 */
