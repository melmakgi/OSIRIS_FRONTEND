...
export const forEach = <T = any>(
  ...
  for (let i = 0; i < list.length; i++) {
    // func возвращает true и завершает обход, избегая бессмысленных циклов с большим количеством узлов,
    // которые могут вызвать задержку браузера
    if (func(list[i])) {
      return
    }
...
/**
 * @description: Извлечение дерева с заданной структурой
 */
 ...
 * @param treeDatas дерево
 * @param callBack Обратный звонок
