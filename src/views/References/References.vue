...
const selectReferences = reactive<FormSchema[]>([
  {
    field: 'fieldSelect',
    label: t('formReferences.selectReferences'),
    component: 'Select',
    componentProps: {
      options: [
        {
  ...
  },
  {
    field: 'fieldDivider',
    component: 'Divider',
    label: t('formReferences.divider')
  },
])
...
<template>
  <ContentWrap :title="t('formReferences.references')" :message="t('formReferences.formDes')">
    <Form :schema="selectReferences" label-width="auto" :label-position="isMobile ? 'top' : 'right'"/>
